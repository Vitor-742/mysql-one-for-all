...
CREATE TABLE SpotifyClone.planos (
	tipo_plano_id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE SpotifyClone.usuarios (
    ...
    FOREIGN KEY (plano_id) REFERENCES planos(tipo_plano_id)
) ENGINE=InnoDB;
...
CREATE TABLE SpotifyClone.cancoes_escutadas (
...
INSERT INTO SpotifyClone.cancoes (titulo, album_id, duracao_segundos)
VALUES
  ('Soul For Us', 1, 200),
...
INSERT INTO SpotifyClone.cancoes_escutadas (cancao_id, usuario_id, data_reproducao)
VALUES
